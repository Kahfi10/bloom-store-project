...
import { products, formatRupiah } from '@/lib/mockData';
...
export default async function ProductDetailPage({
  ...
  return (
    <div className="min-h-screen bg-bloom-bg">
      {/* ── Page wrapper with top padding for sticky nav ── */}
      <div className="max-w-[1200px] mx-auto px-6 pt-28 pb-20">
        ...
        <nav className="flex items-center gap-2 text-sm text-bloom-secondary mb-10 animate-fade-up">
          <Link href="/" className="hover:text-bloom-text transition-colors">
            Beranda
          </Link>
          <svg width="12" height="12" viewBox="0 0 12 12" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round">
            <path d="M4.5 2.5L7.5 6l-3 3.5" />
          </svg>
          <Link href="/#produk" className="hover:text-bloom-text transition-colors">
            Produk
          </Link>
          <svg width="12" height="12" viewBox="0 0 12 12" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round">
            <path d="M4.5 2.5L7.5 6l-3 3.5" />
          </svg>
          <span className="text-bloom-text font-medium truncate max-w-[200px]">
            {product.name}
          </span>
        </nav>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 xl:gap-20">
          ...
          >
            ...
            <div className="space-y-2">
              <h2 className="text-xs font-semibold text-bloom-secondary uppercase tracking-widest">
                Deskripsi
              </h2>
            ...
            <div className="grid grid-cols-2 gap-3">
              {[
                ...
                <div
                  key={label}
                  className="px-4 py-3 bg-bloom-surface rounded-xl border border-bloom-border/60"
                >
                  <p className="text-[11px] font-medium text-bloom-secondary uppercase tracking-wider mb-0.5">
                    {label}
                  </p>
            ...
            {/* Add to Cart Widget (client component) */}
        ...
        <div className="mt-20 pt-12 border-t border-bloom-border">
          <h2 className="text-xl font-bold text-bloom-text mb-6">
            Produk Lainnya
          </h2>
            ...
            {products
              ...
              .map((related) => (
                ...
                >
                  ...
                  <div>
                    <p className="text-sm font-semibold text-bloom-text group-hover:opacity-70 transition-opacity">
                      {related.name}
                    </p>
